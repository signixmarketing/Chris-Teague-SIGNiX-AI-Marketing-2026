...
**Part of the business-domain sequence.** See **PLAN-BIZ-DOMAIN-MASTER.md** for implementation order and how this plan relates to Vehicles and Contacts. **Design:** **DESIGN-BIZ-DOMAIN.md** (entity model, relationships, View/Edit split, UI conventions).
