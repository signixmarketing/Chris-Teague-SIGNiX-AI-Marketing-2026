...
| [DELIVERABLES/](#deliverables) | All output files — PDFs, DOCX, PPTX, XLSX, HTML, email, collateral |
| [build-scripts/](#build-scripts) | Python scripts that generate every deliverable |
| [GENERAL-KNOWLEDGE/](#reference-and-setup) | Design guidelines, writing voice, wkhtmltopdf, SIGNiX API reference |
...
| File | Description |
|------|-------------|
| **[BRIEFING.md](BRIEFING.md)** | **Living session briefing — active initiatives, decisions log, open questions. Read this first every session.** *(local only — not pushed to GitHub)* |
...
| [SIGNIX-MARKETING-PLAN-2026.md](SIGNIX-MARKETING-PLAN-2026.md) | Executive marketing plan — three growth tracks, keyword strategy, KPIs, budget summary |
| [SIGNIX-PAID-MEDIA-PLAN-2026.md](SIGNIX-PAID-MEDIA-PLAN-2026.md) | Full paid media plan (Rev 3, April 6 2026) — budget reallocation, Google keyword buckets, LinkedIn audiences, landing page strategy, 90-day launch plan |
...
All output files live in **[DELIVERABLES/](DELIVERABLES/)**. This is the single folder for everything ready to share, print, or send.

### Paid Media and Campaign Documents

| File | Description |
|------|-------------|
| **[DELIVERABLES/SIGNiX_PaidMedia_4.6.26.docx](DELIVERABLES/SIGNiX_PaidMedia_4.6.26.docx)** | Paid media plan Word doc — Rev 3, April 6 2026 |
| **[DELIVERABLES/SIGNiX_PaidMedia_4.6.26.pptx](DELIVERABLES/SIGNiX_PaidMedia_4.6.26.pptx)** | Paid media slides — Rev 3, 6 slides, ready to present |
| [DELIVERABLES/SIGNIX-PAID-MEDIA-SLIDES-CEO.pptx](DELIVERABLES/SIGNIX-PAID-MEDIA-SLIDES-CEO.pptx) | CEO-trimmed version — simplified slide 4, 3 headline KPIs |
| [DELIVERABLES/SIGNIX-PAID-MEDIA-SLIDES.html](DELIVERABLES/SIGNIX-PAID-MEDIA-SLIDES.html) | HTML presentation deck — keyboard/click navigation, PDF-exportable |
| **[DELIVERABLES/SIGNiX_Keyword_Master_4.6.26.xlsx](DELIVERABLES/SIGNiX_Keyword_Master_4.6.26.xlsx)** | Keyword master Excel — 60+ keywords, status, search volume, CPC, budget allocation, negative keywords |
...
| File | Description |
|------|-------------|
| **[DELIVERABLES/SIGNiX_MarketingPlan_4.7.26.pptx](DELIVERABLES/SIGNiX_MarketingPlan_4.7.26.pptx)** | Leadership marketing plan deck — 6 slides, two-strategy framework, 5 segments, active initiatives |
| [DELIVERABLES/SIGNiX_SlideC_Audiences.pptx](DELIVERABLES/SIGNiX_SlideC_Audiences.pptx) | Standalone audience hub-and-spoke slide |
| **[DELIVERABLES/SIGNiX_ABM_Scorecard.docx](DELIVERABLES/SIGNiX_ABM_Scorecard.docx)** | ABM scorecard — 35-account landscape tracker with weekly activity columns |
| **[DELIVERABLES/SIGNiX_CFO_PaidMedia_Brief_4.6.26.docx](DELIVERABLES/SIGNiX_CFO_PaidMedia_Brief_4.6.26.docx)** | CFO one-pager — keyword data, volume math, ROI frame |
| **[DELIVERABLES/SIGNiX_CRO_PaidMedia_Brief_4.6.26.docx](DELIVERABLES/SIGNiX_CRO_PaidMedia_Brief_4.6.26.docx)** | CRO one-pager — lead volume concerns, 90-day projections, ROI math |

### ABS / CoPilot Partner Collateral

| File | Description |
|------|-------------|
| **[DELIVERABLES/SIGNiX_ABS_CoPilot_OnePager_v2_aspen.html](DELIVERABLES/SIGNiX_ABS_CoPilot_OnePager_v2_aspen.html)** | Source HTML — partner overview one-pager. Edit to regenerate PDF. |
...
All scripts live in **[build-scripts/](build-scripts/)**. Each generates a branded deliverable using SIGNiX brand tokens. Run from the `PROJECT-DOCS/` directory.
...
| [build-scripts/build_signix_paid_media_4_6_26_pptx.py](build-scripts/build_signix_paid_media_4_6_26_pptx.py) | `DELIVERABLES/SIGNiX_PaidMedia_4.6.26.pptx` |
| [build-scripts/build_signix_paid_media_4_6_26_docx.py](build-scripts/build_signix_paid_media_4_6_26_docx.py) | `DELIVERABLES/SIGNiX_PaidMedia_4.6.26.docx` |
| [build-scripts/build_signix_measurement_timeline_docx.py](build-scripts/build_signix_measurement_timeline_docx.py) | `DELIVERABLES/SIGNiX_CampaignMeasurement_April2026.docx` |
...
| [GENERAL-KNOWLEDGE/SETUP-WKHTMLTOPDF.md](GENERAL-KNOWLEDGE/SETUP-WKHTMLTOPDF.md) | wkhtmltopdf setup — how to install and use for HTML-to-PDF generation |
...
| [ARCHIVE/20-APPROACH.md](ARCHIVE/20-APPROACH.md) | AI-assisted document-driven development methodology |
| [ARCHIVE/project-cleanup.md](ARCHIVE/project-cleanup.md) | Cleanup plan from April 9 2026 — implemented, kept for reference |
| [ARCHIVE/project-structure-recommendations.md](ARCHIVE/project-structure-recommendations.md) | Structure recommendations from April 9 2026 — implemented, kept for reference |
| [ARCHIVE/GENERAL-KNOWLEDGE/](ARCHIVE/GENERAL-KNOWLEDGE/) | App foundation, document-centric patterns, file/media handling |
...
*Last updated: April 9, 2026 — project fully restructured as SIGNiX Marketing Toolkit*
