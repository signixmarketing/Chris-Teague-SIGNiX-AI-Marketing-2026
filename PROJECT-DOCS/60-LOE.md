...
3. **Timeline:** With a known availability (e.g. person-days per week), the WBS and LOE support a high-level timeline or GANTT; PLAN-MASTER and the phase plans remain the source for execution order.
