...
**Part of the business-domain sequence.** See **PHASE-PLANS-BIZ-DOMAIN.md** for implementation order and how this plan relates to Contacts and Deals. **Design:** **DESIGN-BIZ-DOMAIN.md** (entity model, relationships, UI conventions).
