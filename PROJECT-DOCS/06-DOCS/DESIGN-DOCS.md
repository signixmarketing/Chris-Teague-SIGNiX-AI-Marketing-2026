...
- **Mapping** — Parse DTL to extract template variables, use the Internal Data Schema (see ../04-DATA-INTERFACE/DESIGN-DATA-INTERFACE.md) for available paths, provide a UI to map variables to data sources and transforms, and apply the mapping at render time. See [Template-to-Data Mapping](#template-to-data-mapping).
...
- The mapping UI and context builder use the **Internal Data Schema** (see ../04-DATA-INTERFACE/DESIGN-DATA-INTERFACE.md), not ad-hoc model introspection.
