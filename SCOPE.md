...
This document states **what is in scope** and **what is out of scope** for this version of the lease origination sample application. It complements **REQUIREMENTS.md** (what the system must do) and **PROJECT-PITCH.md** (why we are doing the project). Scope may be revised when we add or defer features; approach is in **APPROACH.md**.
...
- **Requirements, scope, approach**: REQUIREMENTS.md, SCOPE.md, APPROACH.md, and PROJECT-PITCH.md so that stakeholders, scope, and approach are explicit and maintainable.
...
The following are **explicitly out of scope** for this version. They are not requirements (see REQUIREMENTS.md Section 5) and are not planned for implementation in the current PLAN set. They may be revisited in a later version or in a derivative project.
...
- **Scope for the new project**: The new project should define its own SCOPE.md (and REQUIREMENTS.md, APPROACH.md) so that in/out of scope is clear for that application.

---

*What the system must do: **REQUIREMENTS.md**. Why we are doing the project: **PROJECT-PITCH.md**. How we build and document: **APPROACH.md**. Work-breakdown and effort: **WBS.md**, **LOE.md**.*
